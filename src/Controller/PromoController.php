...
class PromoController extends AbstractController
{
    ...
    #[Route('/{code}', name: 'app_promo_show', methods: ['GET'])]
    ...
    #[Route('/{code}/edit', name: 'app_promo_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{code}', name: 'app_promo_delete', methods: ['POST'])]
    public function delete(Request $request, Promo $promo, EntityManagerInterface $entityManager): Response
    {
        if ($this->isCsrfTokenValid('delete'.$promo->getCode(), $request->request->get('_token'))) {
